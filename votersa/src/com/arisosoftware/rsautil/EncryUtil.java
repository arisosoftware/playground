...
public class EncryUtil {
	 ...
	 * @throws Exception 
	 */
	public static String handleHmac(TreeMap<String, String> map, String hmacKey) throws Exception {
		StringBuffer sbuffer = new StringBuffer();
		...
		if (StringUtils.isNotEmpty(hmacKey)) {
			hmac = Digest.hmacSHASign(hmacTemp, hmacKey,  ConstName.CHAR_ENCODING_UTF8);
		}
		return hmac;
	}
}
